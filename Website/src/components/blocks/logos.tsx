          ...
          {companies.map((company, index) => (
            <Link href={company.href} target="_blank" key={index}>
              <Image
                ...
                className="object-contain opacity-50 transition-opacity hover:opacity-70 dark:opacity-100 dark:invert"
              />
            </Link>
          ))}
        </div>
          ...
          {companies.map((company, index) => (
            ...
            >
              <Image
                ...
                width={company.width}
                height={company.height}
                className="object-contain opacity-50 dark:opacity-100 dark:invert"
              />
            </Link>
          ))}
        </Marquee>
