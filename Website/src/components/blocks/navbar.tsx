    ...
    dropdownItems: [
      {
        ...
        description:
          "Military-grade AES-256 encryption for all traffic",
      },
      {
        title: "Admin Dashboard",
        href: "/#resource-allocation",
        description: "Centralized management for your entire team",
      },
    ],
  },
...
export const Navbar = () => {
  ...
  return (
    <section
      className={cn(
        "bg-background/70 absolute left-1/2 z-50 w-[min(92%,880px)] -translate-x-1/2 rounded-4xl border backdrop-blur-md transition-all duration-300",
        "top-5 lg:top-12",
      )}
    >
              ...
              link.dropdownItems ? (
                ...
                <NavigationMenuItem key={link.label} className="">
                  <Link
                    href={link.href}
                    className={cn(
                      "relative whitespace-nowrap bg-transparent px-1.5 text-sm font-medium transition-opacity hover:opacity-75",
