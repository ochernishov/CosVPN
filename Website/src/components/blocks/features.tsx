      ...
      <div className="container">
        ...
        <div className="mx-auto mt-10 grid max-w-4xl items-center gap-3 md:gap-0 lg:mt-24 lg:grid-cols-2">
          ...
          <p className="text-muted-foreground leading-snug">
            {process.env.NEXT_PUBLIC_SITE_NAME} combines cutting-edge cryptography with blazing-fast
            WireGuard protocol, giving your team the security they need without
            sacrificing speed.
          </p>
        </div>
