...
const topItems = [
  {
    ...
    description:
      "Route only business traffic through the VPN while keeping personal browsing direct.",
    images: [
      {
  ...
  {
    title: "Simplify your security stack.",
    description: "Replace multiple security tools with one unified VPN platform.",
    images: [
...
const bottomItems = [
  {
    ...
    description:
      "Automatically block internet access if the VPN connection drops.",
    images: [
      {
  ...
  },
  {
    ...
    description:
      "Assign roles, manage permissions, and control who connects to what.",
    images: [
      {
  ...
  },
  {
    ...
    description:
      "Get instant notifications about suspicious activity and connection anomalies.",
    images: [
      {
    ...
    >
      <div className="">
        <h2 className="container text-center text-3xl tracking-tight text-balance sm:text-4xl md:text-5xl lg:text-6xl">
          Secure your entire organization with one platform
        </h2>
